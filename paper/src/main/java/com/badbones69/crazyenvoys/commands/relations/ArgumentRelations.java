package com.badbones69.crazyenvoys.commands.relations;

import com.badbones69.crazyenvoys.api.enums.Messages;
import com.badbones69.crazyenvoys.commands.MessageManager;
...
public class ArgumentRelations extends MessageManager {
    ...
    @Override
    public void build() {
        this.commandManager.registerMessage(BukkitMessageKey.UNKNOWN_COMMAND, (sender, context) -> Messages.command_not_found.sendMessage(sender, "{command}", context.getInvalidInput()));
        ...
        this.commandManager.registerMessage(BukkitMessageKey.PLAYER_ONLY, (sender, context) -> Messages.player_only.sendMessage(sender));
