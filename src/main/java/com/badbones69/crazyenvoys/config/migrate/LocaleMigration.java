...
public class LocaleMigration extends PlainMigrationService {
    ...
    protected boolean performMigrations(@NotNull PropertyReader reader, @NotNull ConfigurationData configurationData) {
        return Properties.no_permission.moveString(reader, configurationData)
                ...
                | Properties.left.moveList(reader, configurationData)
                | Properties.left_list.moveStringToList(reader, configurationData)
                | Properties.ended.moveList(reader, configurationData)
                | Properties.ended_list.moveStringToList(reader, configurationData)
                ...
                | Properties.time_till_event.moveList(reader, configurationData)
                | Properties.time_till_event_list.moveStringToList(reader, configurationData)
