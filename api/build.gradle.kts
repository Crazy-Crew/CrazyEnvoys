...
project.group = "us.crazycrew.crazyenvoys"
project.description = "The official API for CrazyEnvoys!"
...
tasks {
    javadoc {
        ...
        options.header = """<img src="https://raw.githubusercontent.com/Crazy-Crew/Branding/refs/heads/main/crazyenvoys/png/64x64.png" style="height:100%">"""
...
publishing {
    ...
    publications {
        create<MavenPublication>("mavenJava") {
            groupId = "${project.group}" // us.crazycrew.crazyenvoys
